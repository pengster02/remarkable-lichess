...
mod tests {
    ...
    fn save_then_load_round_trips_move_confirmation() {
        ...
        let settings = AppSettings { auto_queen_promotion: false, move_confirmation: true, minimal_highlights: false };
    ...
    fn save_then_load_round_trips_minimal_highlights() {
        ...
        let settings = AppSettings { auto_queen_promotion: false, move_confirmation: false, minimal_highlights: true };
        save(&path, &settings).unwrap();
        assert_eq!(load(&path), settings);
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn save_then_load_round_trips() {
        ...
        let settings = AppSettings { auto_queen_promotion: true, move_confirmation: false, minimal_highlights: false };
        save(&path, &settings).unwrap();
        assert_eq!(load(&path), settings);
        let _ = std::fs::remove_file(&path);
    }
